...
class IssuesTest < ApplicationSystemTestCase
  ...
  test "creating a Issue" do
    ...
    fill_in "Collectiondate", with: @issue.collectiondate
    fill_in "Comment", with: @issue.comment
    fill_in "Issuedate", with: @issue.issuedate
    fill_in "Room", with: @issue.room_id
